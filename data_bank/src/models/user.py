...
class User(SQLAlchemyBaseUserTable[int], Base):
    ...
    is_news_bot: Mapped[bool] = mapped_column(Boolean, nullable=False, unique=False, default=False)
    is_instruktor_bot: Mapped[bool] = mapped_column(Boolean, nullable=False, unique=False, default=False)
