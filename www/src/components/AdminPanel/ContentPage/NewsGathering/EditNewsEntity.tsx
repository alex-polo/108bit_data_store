...
export const EditNewsEntity = () => {
  ...
  const saveMutation = useUpdateNewsEntity();
  const queryNewsEntity = useNewsEntityByName(siteName);
  ...
  useEffect(() => {
    if (queryNewsEntity.newsEntity?.id != undefined) setId(queryNewsEntity.newsEntity?.id);
    if (queryNewsEntity.newsEntity?.name != undefined) setName(queryNewsEntity.newsEntity?.name);
    if (queryNewsEntity.newsEntity?.url != undefined) setUrl(queryNewsEntity.newsEntity?.url);
    if (queryNewsEntity.newsEntity?.description != undefined) setDescription(queryNewsEntity.newsEntity?.description);
    if (queryNewsEntity.newsEntity?.vendor != undefined) setVendor(queryNewsEntity.newsEntity?.vendor);
    if (queryNewsEntity.newsEntity?.field_tags != undefined) setFieldTags(queryNewsEntity.newsEntity?.field_tags);
    if (queryNewsEntity.newsEntity?.parser_id != undefined) setParserId(queryNewsEntity.newsEntity?.parser_id);
    if (queryNewsEntity.newsEntity?.is_enable != undefined) setIsEnable(queryNewsEntity.newsEntity?.is_enable);
