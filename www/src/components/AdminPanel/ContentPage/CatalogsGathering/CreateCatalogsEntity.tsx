...
import { useCreateCatalogEntity, useGetCatalogParsers } from '../../../../services/AdminPanelService/hooks';
...
export const CreateCatalogsEntity = () => {
  ...
  const saveMutation = useCreateCatalogEntity();
  ...
  if (queryParsers.isError) {
    return (
      <>
        <Row>
          <h1>Создание ресурса каталога</h1>
